                ...
                userCourses.map((course) => (
                  ...
                  >
                    ...
                    <div className="px-[30px] py-[24px]">
                      ...
                      <button
                        className={`mt-[40px] mb-[15px] h-[52px] w-full rounded-full bg-btnPrimaryRegular hover:bg-btnPrimaryHover active:bg-btnPrimaryActive ${activeButton === course._id ? "text-white" : "text-black"
                          }`}
