        ...
        <main className="">
          ...
          <div className="mb-[84px] rounded-[30px] shadow-[0px_4px_67px_-12px_#00000021] desktop:mb-[200px] desktop:rounded-3xl">
            <section className="p-[30px] desktop:p-[40px]">
              ...
              <button onClick={()=>(console.log("Открывается модалка с выбором тренировки"))} className="mt-10 h-[52px] w-[283px] rounded-full bg-[#BCEC30] text-lg hover:bg-[#C6FF00] active:bg-black active:text-white desktop:w-80">
